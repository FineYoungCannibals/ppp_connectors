...
from apiary.api_connectors.flashpoint import AsyncFlashpointConnector
...
@patch("apiary.api_connectors.flashpoint.AsyncFlashpointConnector.post", new_callable=AsyncMock)
@pytest.mark.asyncio
