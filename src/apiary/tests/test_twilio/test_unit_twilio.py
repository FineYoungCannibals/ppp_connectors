...
from apiary.api_connectors.twilio import TwilioConnector
...
@patch("apiary.api_connectors.broker.combine_env_configs", return_value={})
...
@patch("apiary.api_connectors.twilio.TwilioConnector._make_request")
